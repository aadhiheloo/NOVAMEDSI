          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a href="about.php" class="banner-1 h-100 d-flex" style="background-image: url('images/bg_1.jpg');">
              <div class="banner-1-inner align-self-center">
                ...
                <p>At Novameds.com, we ensure that you get high-quality life-saving medicines are delivered to you on time.
                </p>
              </div>
            </a>
          </div>
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a href="about.php" class="banner-1 h-100 d-flex" style="background-image: url('images/bg_2.jpg');">
              <div class="banner-1-inner ml-auto  align-self-center">
                ...
                <p>Novameds.com continues a legacy of 100 years of success in the pharmaceutical industry.</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                ...
                <div class="block-7">
                    ...
                    <p>Novameds.com, Online Medical Store, is brought to you by the Pharma & Company – one of
            ...
            <div class="col-md-6 col-lg-3">
                <div class="block-5 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="email">Novameds@gmail.com</li>
                    </ul>
                </div>
